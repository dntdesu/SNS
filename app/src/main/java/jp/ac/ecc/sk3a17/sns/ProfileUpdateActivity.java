...
public class ProfileUpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cover = findViewById(R.id.profile_update_cover);
        avatar = findViewById(R.id.profile_update_avatar);
        userName = findViewById(R.id.profile_update_user_name);
        fullName = findViewById(R.id.profile_update_full_name);
        status = findViewById(R.id.profile_update_status);
        loadingBar = new ProgressDialog(this);
        saveButton = findViewById(R.id.profile_update_save);
                                            ...
                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    if (task.isSuccessful()) {
                                                        ...
                                                        Toast.makeText(ProfileUpdateActivity.this, "Error Occurred..." + message, Toast.LENGTH_SHORT).show();
                                                        loadingBar.dismiss();
                                                    }
                                                }
                                            });
    ...
    private void SendToMain() {
        Intent mainIntent = new Intent(ProfileUpdateActivity.this, MainActivity.class);
